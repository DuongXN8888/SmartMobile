        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <ul class="list-unstyled social pull-right">
                  <li><a href="https://www.facebook.com/MetaVietnam/"><i class="fab fa-facebook-f"></i></a></li>
                  <li><a href="https://tweetdeck.twitter.com/"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>217 Hai Bà Trưng - Hà Nội</span>
                    </li>
                    <li class="clearfix">
                    ...
                    <li class="clearfix">
                        ...
                        <span><a href="mailto:alaken2345@gmail.com">alaken2345@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>

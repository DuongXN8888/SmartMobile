									...
									<tbody>
										<?php foreach ($list as $row):?>
											...
											<td class="text-center">
												...
												<td class="text-center">
													<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/category/update/<?php echo $row['id'] ?>" onclick="return confirm('Xác nhận Sửa loại sản phẩm này ?')" role = "button">

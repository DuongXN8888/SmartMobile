<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-picture"></i> Quản lý các trang</h1>
								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $row):?>
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/sliders/update/<?php echo $row['id'] ?>" onclick="return confirm('Xác nhận Sửa slider này ?')" role = "button">

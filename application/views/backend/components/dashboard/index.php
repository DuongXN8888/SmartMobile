...
<div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
          ...
          <a href="<?php echo base_url() ?>admin/producer" class="small-box-footer"> Danh Sách Nhà Cung Cấp</a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-xs-6">
  ...
  <script>
   ...
   function drawVisualization() {
    ...
    var options = {
      title: 'Số lượng bán ra từ 09/2021 - 12/2021',
      seriesType: 'bars'
    };

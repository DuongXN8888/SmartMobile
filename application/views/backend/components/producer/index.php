										...
										<tbody>
											<?php foreach ($list as $row):?>
												<tr>
													...
													<td class="text-center">
															<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/producer/update/<?php echo $row['id'] ?>" onclick="return confirm('Bạn Có Muốn Sửa Đổi Nhà Cung Cấp Không ?')" role = "button">

											...
											<?php foreach ($list as $row):?>
												<tr>
													...
													<td class="text-center">
														...
														<td class="text-center">
															<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/product/update/<?php echo $row['id'] ?>" onclick="return confirm('Xác nhận Sửa sản phẩm này ?')" role = "button">
